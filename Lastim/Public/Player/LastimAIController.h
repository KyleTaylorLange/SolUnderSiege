...
#include "LastimAIController.generated.h"
 ...
 *  I really have no clue how this works yet, so this will
 *  be highly derivative of the ShooterGame implementation.
 */
UCLASS()
class LASTIM_API ALastimAIController : public AAIController
{
	GENERATED_BODY()
...
public:
	...
	ALastimAIController(const FObjectInitializer& ObjectInitializer);
	...
	UFUNCTION(BlueprintCallable, Category = Behavior)
	bool FindClosestEnemyWithLOS(ALastimCharacter* ExcludeEnemy = nullptr);
	...
	/* Returns the LastimCharacter. */
	virtual ALastimCharacter* GetLastimPawn();
