...
#include "LastimWeapon.generated.h"
 ...
 */
UCLASS(Abstract)
class LASTIM_API ALastimWeapon : public ALastimInventory
{
	GENERATED_BODY()
...
public:
	...
	ALastimWeapon(const FObjectInitializer& ObjectInitializer);
	...
	TArray<TSubclassOf<ALastimProjectile>> ProjectileClass;
	//TSubclassOf<ALastimProjectile > ProjectileClass;

	/** play weapon animations */
	float PlayWeaponAnimation(UAnimMontage* Anim1P, UAnimMontage* Anim3P); //(const FWeaponAnim& Animation);

	/** stop playing weapon animations */
	void StopWeaponAnimation(UAnimMontage* Anim1P, UAnimMontage* Anim3P); //(const FWeaponAnim& Animation);
