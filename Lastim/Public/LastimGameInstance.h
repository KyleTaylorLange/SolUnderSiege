...
#include "LastimGameInstance.generated.h"
 ...
 */
UCLASS(config = Game)
class LASTIM_API ULastimGameInstance : public UGameInstance
{
...
public:
	...
	/* Returns the ALastimGameSession. */
	ALastimGameSession* GetGameSession() const;
