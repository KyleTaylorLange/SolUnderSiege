...
#include "LastimProjectile.generated.h"

UCLASS(config=Game)
class ALastimProjectile : public AActor
{
	GENERATED_BODY()

public:
	ALastimProjectile(const FObjectInitializer& ObjectInitializer);
	...
	// MOVED THE BELOW COMPONENTS TO PUBLIC SO THEY CAN BE REWRITTEN IN SUBCLASSES.
