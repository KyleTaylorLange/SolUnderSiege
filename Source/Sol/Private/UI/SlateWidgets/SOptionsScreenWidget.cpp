...
{
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "MoveForwardBind", "Move Forward")))
		->AddMapping("MoveForward", 1.0f)
		->AddDefaults(EKeys::E)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "MoveBackwardBind", "Move Backward")))
		->AddMapping("MoveForward", -1.0f)
		->AddDefaults(EKeys::D)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "MoveLeftBind", "Move Left")))
		->AddMapping("MoveRight", -1.0f)
		->AddDefaults(EKeys::S)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "MoveRightBind", "Move Right")))
		->AddMapping("MoveRight", 1.0f)
		->AddDefaults(EKeys::F)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "FireBind", "Fire")))
		->AddMapping("Fire")
		->AddDefaults(EKeys::LeftMouseButton)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "AimBind", "Aim")))
		->AddMapping("Aim")
		->AddDefaults(EKeys::RightMouseButton)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "ReloadBind", "Reload")))
		->AddMapping("Reload")
		->AddDefaults(EKeys::R)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "SwitchFireModeBind", "Switch Fire Mode")))
		->AddMapping("SwitchFireMode")
		->AddDefaults(EKeys::A, EKeys::Enter)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "UseBind", "Use")))
		->AddMapping("Use")
		->AddDefaults(EKeys::Q, EKeys::Enter)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "JumpBind", "Jump")))
		->AddMapping("Jump")
		->AddDefaults(EKeys::SpaceBar)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "CrouchBind", "Crouch")))
		->AddMapping("Crouch")
		->AddDefaults(EKeys::LeftControl)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "SprintBind", "Sprint")))
		->AddMapping("Sprint")
		->AddDefaults(EKeys::LeftShift)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "PrevWeaponBind", "Select Previous Weapon")))
		->AddMapping("PreviousWeapon")
		->AddDefaults(EKeys::One)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "NextWeaponBind", "Select Next Weapon")))
		->AddMapping("NextWeapon")
		->AddDefaults(EKeys::Two)));
	Binds.Add(MakeShareable((new FControlBind(NSLOCTEXT("Sol.HUD.Menu", "ShowScoreboardBind", "Show Scoreboard")))
...
TSharedRef<SWidget> SOptionsScreenWidget::MakeOptionsWindow()
{
	...
	[
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(NSLOCTEXT("Sol.HUD.Menu", "PlayerNameOption", "Player Name"))
			]
		]
		+ SHorizontalBox::Slot()
		[
	...
	[
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(NSLOCTEXT("Sol.HUD.Menu", "MouseSensitivity", "Mouse Sensitivity"))
			]
		]
		+ SHorizontalBox::Slot()
		[
	...
	[
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(NSLOCTEXT("Sol.HUD.Menu", "PrimaryColor", "<Enhanced>Primary</> Color"))
	...
	[
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(NSLOCTEXT("Sol.HUD.Menu", "SecondaryColor", "Secon<Enhanced>dary Col</>or"))
