...
AWeap_D9Pistol::AWeap_D9Pistol(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	FireMode[0].TimeBetweenShots = 0.145f;
	FireMode[0].ShotsPerBurst = 1;
	FireMode[0].BulletProps = FBulletProperties::FBulletProperties(FLinearColor(0.25f, 0.55f, 0.89f), 9, 260);
	FireMode[0].AmmoPerShot = 40;
